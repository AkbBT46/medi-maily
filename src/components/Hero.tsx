...
const Hero = () => {
  ...
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-br from-medimaily-50 to-white overflow-hidden">
      <div className="container-custom text-center relative">
        ...
        <h1 
          className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-medimaily-900 max-w-4xl mx-auto transition-all duration-700 ease-out ${
        ...
        <p 
          className={`text-lg md:text-xl text-medimaily-700 mb-6 max-w-2xl mx-auto transition-all duration-700 delay-100 ease-out ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
        ...
        <p 
          className={`text-lg md:text-xl font-medium text-medimaily-600 mb-10 transition-all duration-700 delay-200 ease-out ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
        ...
        <div 
          className={`flex flex-col sm:flex-row justify-center gap-4 transition-all duration-700 delay-300 ease-out ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
        ...
        <div 
          className={`mt-16 md:mt-20 relative transition-all duration-700 delay-500 ease-out ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-center text-center">
          {['Kunde 1', 'Kunde 2', 'Kunde 3', 'Kunde 4'].map((kunde, index) => (
            <div 
              key={index} 
              className={`grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-500 delay-${index * 100} ease-out ${
