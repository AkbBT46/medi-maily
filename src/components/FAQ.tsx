    ...
    <section className="section-padding bg-white">
      <div className="container-custom">
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqs.map((faq, index) => (
              <AccordionItem key={index} value={`item-${index}`} className="border-b border-blue-200">
                <AccordionTrigger className="text-lg text-blue-900 hover:text-blue-600 py-5">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-blue-700 pb-5">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
        ...
        <div className="text-center mt-10 animate-on-scroll">
          <p className="mb-5 text-blue-700">Haben Sie weitere Fragen?</p>
