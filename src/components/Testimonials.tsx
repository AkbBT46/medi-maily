...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "MediMaily transformed our patient outreach. We've seen a 40% increase in appointment bookings from email campaigns alone.",
      author: "Dr. Sarah Johnson",
      position: "Smile Bright Dental",
      image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80"
    },
    {
      quote: "Their team understood exactly what our practice needed. The personalized follow-up emails have dramatically improved our patient retention.",
      author: "Dr. Michael Chen",
      position: "Pacific Heights Dental",
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=200&q=80"
    },
    {
      quote: "I'm impressed with how easy MediMaily makes email marketing. We're connecting with patients in a meaningful way without adding to our workload.",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">
            Dental professionals trust MediMaily to help grow their practices.
          </p>
        </div>
        ...
        <div className="mt-16 flex justify-center">
          <div className="bg-medimaily-50 rounded-lg p-8 max-w-3xl text-center">
            <p className="text-xl text-medimaily-700 mb-4">
              "MediMaily has been a game-changer for our dental practice. Their email automation has generated over $150,000 in additional revenue this year."
            </p>
