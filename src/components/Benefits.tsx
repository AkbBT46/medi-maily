...
const Benefits = () => {
  ...
  return (
    <section id="features" className="section-padding bg-blue-50" ref={sectionRef}>
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="animate-on-scroll bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-200 hover:border-blue-400 transform hover:-translate-y-1 card-hover"
        ...
        <div className="mt-16 p-8 rounded-lg bg-gradient-to-r from-blue-100 to-blue-50 border border-blue-200 shadow-lg animate-on-scroll">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0 md:pr-8">
              <h3 className="text-2xl font-bold mb-2 text-blue-900">Bereit, Ihre Praxis zu vergrößern?</h3>
              <p className="text-blue-700">Vereinbaren Sie eine kostenlose 30-minütige Beratung mit unseren Experten.</p>
            </div>
