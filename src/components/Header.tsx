...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-medimaily-900/95 to-medimaily-800/95 backdrop-blur-md border-b border-white/10">
      ...
      {/* MacOS Dock positioned lower in the layout */}
      <div className="fixed top-96 left-1/2 transform -translate-x-1/2 z-40 mt-8">
        <MacOSDock
          apps={sampleApps}
          onAppClick={handleAppClick}
          openApps={openApps}
